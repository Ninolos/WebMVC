...
namespace WebSalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Michael Scott", "michael@dunder-mifflin.com", new DateTime(1978, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Jim Halpert", "jim@dunder-mifflin.com", new DateTime(1991, 8, 10), 900.0, d1);
            Seller s3 = new Seller(3, "Dwigth Schrute", "dwigth@dunder-mifflin.com", new DateTime(1988, 2, 5), 1000.0, d2);
            Seller s4 = new Seller(4, "Pam Beasley", "pam@dunder-mifflin.com", new DateTime(1993, 12, 18), 900.0, d3);
            Seller s5 = new Seller(5, "Andy Berbard", "andy@dunder-mifflin.com", new DateTime(1990, 3, 7), 800.0, d2);
            Seller s6 = new Seller(6, "Stanley Hudson", "stanley@dunder-mifflin.com", new DateTime(1970, 1, 1), 950.0, d4);
